    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12">
          <h1>Liên hệ</h1>
          <h3>
            <a href="https://phpscriptpoint.com/cc/courseplus/">Trang chủ</a>
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-md-6 contact-container">
          <h3>Liên hệ với chúng tôi thông qua biểu mẫu:</h3>
          <form action="#" className="contact-form" method="post" acceptCharset="utf-8">
            ...
            <button type="submit" className="btn btn-default btn-success" name="form_contact">Gửi</button>
          </form>
        </div>
      </div>
    </div>
